...
1. Rebase/copy the next upstream release while preserving its license/history files.
2. Reapply the isolated MaterialGraph directory and Pipe unchanged where possible.
...
6. Review `git diff --name-only` and reject unrelated Open WebUI churn.
